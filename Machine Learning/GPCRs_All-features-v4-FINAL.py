...
selected_features = [
    ...
    'sasa_total', 'sasa_crg', 'sasa_plr', 'sasa_aplr', 'alpha_helix', '3_10_helix', 'extended_configuration', 
...
# :::{markdown}
# ## 4. Supervised Classification Pipeline: Data Splitting, Scaling, Modeling, and Evaluation
# 
# This section performs end-to-end supervised learning using a Random Forest classifier to predict low versus high GPCR PME. Key steps include:
# - Stratified train-test splitting
# - Model training with class balancing
# - Performance evaluation (metrics, ROC, confusion matrix)
# - Feature interpretation (Random Forest + SHAP)
# - ROC data export for external plotting
# 
# Random Forest was selected for its:
# 1. Robustness to feature correlations
# 2. Native handling of non-linear relationships
# 3. Feature importance quantitation capability
# :::
