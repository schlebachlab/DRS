...
Each suprvised machine learning scripts follows a consistent pipeline:
  ...
  3.	Train ML models to classify GPCRs as high vs low PME. All versions train a Random Forest classifier but differs in hyperparameter optimization and resampling. v1 — No Hyperparameter Tuning, v2 — RandomizedSearchCV, v3 — GridSearchCh, v4 — SMOTE + GridSearchCV
